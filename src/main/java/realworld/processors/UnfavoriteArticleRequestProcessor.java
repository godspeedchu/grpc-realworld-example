...
class UnfavoriteArticleRequestProcessor implements GrpcRequestProcessor<UnfavoriteArticleRequest, ArticleResponse> {

  private final UserDao userDao;
  private final ArticleDao articleDao;

  @Inject
  UnfavoriteArticleRequestProcessor(UserDao userDao, ArticleDao articleDao) {
    this.userDao = userDao;
    this.articleDao = articleDao;
  }

  @Override
  public ListenableFuture<ArticleResponse> execute(UnfavoriteArticleRequest request) {
    ...
    articleDao.unfavoriteArticle(userId, dbArticle.get().getId());
