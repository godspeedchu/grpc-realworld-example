...
class FollowProfileRequestProcessor implements GrpcRequestProcessor<FollowProfileRequest, ProfileResponse> {

  private final UserDao userDao;

  @Inject
  FollowProfileRequestProcessor(UserDao userDao) {
    this.userDao = userDao;
  }

  @Override
  public ListenableFuture<ProfileResponse> execute(FollowProfileRequest request) {
    ...
    userDao.followUser(userId, user.getId());
